...
class Stack
{
	...
	public function initiate ($iKey = null, $sHex = null): bool {
		switch ($sHex) {
			...
			case 0x01: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //ADD
			case 0x02: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //MUL
			case 0x03: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SUB
			case 0x04: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //DIV
			case 0x05: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SDIV
			case 0x06: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //MOD
			case 0x07: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SMOD
			case 0x08: $this->aArguments = array_slice($this->aHex, $iKey + 1, 3); break; //ADDMOD
			case 0x09: $this->aArguments = array_slice($this->aHex, $iKey + 1, 3); break; //MULMOD
			case 0x0a: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //EXP
			case 0x0b: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SIGNEXTEND
			case 0x10: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //LT
			case 0x11: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //GT
			case 0x12: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SLT
			case 0x13: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SGT
			case 0x14: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //EQ
			case 0x15: $this->aArguments = array_slice($this->aHex, $iKey + 1, 1); break; //ISZERO
			case 0x16: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //AND
			case 0x17: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //OR
			case 0x18: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //XOR
			case 0x19: $this->aArguments = array_slice($this->aHex, $iKey + 1, 1); break; //NOT
			case 0x1a: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //BYTE
			case 0x20: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SHA3
			...
			case 0x37: $this->aArguments = array_slice($this->aHex, $iKey + 1, 3); break; //CALLDATACOPY
			case 0x38: $this->aArguments = array_slice($this->aHex, $iKey + 1, 1); break; //CODESIZE
			case 0x39: $this->aArguments = array_slice($this->aHex, $iKey + 1, 3); break; //CODECOPY
			...
			case 0x3c: $this->aArguments = array_slice($this->aHex, $iKey + 1, 3); break; //EXTCODECOPY
			...
			case 0x52: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //MSTORE
			case 0x53: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //MSTORE8
			case 0x54: $this->aArguments = array_slice($this->aHex, $iKey + 1, 1); break; //SLOAD
			case 0x55: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //SSTORE
			case 0x56: $this->aArguments = array_slice($this->aHex, $iKey + 1, 1); break; //JUMP
			case 0x57: $this->aArguments = array_slice($this->aHex, $iKey + 1, 2); break; //JUMPI
