...
class Stack
{
	...
	public function initiate ($iKey = null, $sHex = null): bool {
		...
		switch ($sHex) {
			...
			case 0x30: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //ADDRESS
			case 0x31: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //BALANCE
			case 0x32: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //ORIGIN
			case 0x33: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //CALLER
			case 0x34: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //CALLVALUE
			case 0x35: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //CALLDATALOAD
			case 0x36: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //CALLDATASIZE
			case 0x37: $this->aArguments = array_slice($this->aHex, $iKey, 3); break; //CALLDATACOPY
			case 0x38: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //CODESIZE
			case 0x39: $this->aArguments = array_slice($this->aHex, $iKey, 3); break; //CODECOPY
			case 0x3a: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //GASPRICE
			...
			case 0x41: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //COINBASE
			case 0x42: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //TIMESTAMP
			case 0x43: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //NUMBER
			case 0x44: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //DIFFICULTY
			case 0x45: $this->aArguments = array_slice($this->aHex, $iKey, 1); break; //GASLIMIT
