...
class Opcodes extends Box
{
	...
	public function set_opcodes () {
		$this->aaOpcodes = array(
			...
			0x0b => array(0, 0, 5, 0x0b, "SIGNEXTEND", "Extend length of two’s complement signed integer"),
			0x10 => array(0, 0, 3, 0x10, "LT", "Less-than comparison"),
			0x11 => array(0, 0, 3, 0x11, "GT", "Greater-than comparison"),
			0x12 => array(0, 0, 3, 0x12, "SLT", "Signed less-than comparison"),
			0x13 => array(0, 0, 3, 0x13, "SGT", "Signed greater-than comparison"),
			0x14 => array(0, 0, 3, 0x14, "EQ", "Equality comparison"),
			0x15 => array(0, 0, 3, 0x15, "ISZERO", "Simple not operator"),
			0x16 => array(0, 0, 3, 0x16, "AND", "Bitwise AND operation"),
			0x17 => array(0, 0, 3, 0x17, "OR", "Bitwise OR operation"),
			0x18 => array(0, 0, 3, 0x18, "XOR", "Bitwise XOR operation"),
			0x19 => array(0, 0, 3, 0x19, "NOT", "Bitwise NOT operation"),
			0x1a => array(0, 0, 3, 0x1a, "BYTE", "Retrieve single byte from word"),
			0x1c => array(0, 0, 3, 0x1c, "SHR", "Logical right shift operation"),
			0x20 => array(0, 0, 30, 0x20, "SHA3", "Compute Keccak-256 hash"),
			0x30 => array(0, 0, 2, 0x30, "ADDRESS", "Get address of currently executing account"),
			0x31 => array(0, 0, 20, 0x31, "BALANCE", "Get balance of the given account"),
			...
			0x35 => array(0, 0, 3, 0x35, "CALLDATALOAD", "Get input data of current environment"),
			0x36 => array(0, 0, 2, 0x36, "CALLDATASIZE", "Get size of input data in current environment"),
			0x37 => array(0, 0, 3, 0x37, "CALLDATACOPY", "Copy input data in current environment to memory"),
			0x38 => array(0, 0, 2, 0x38, "CODESIZE", "Get size of code running in current environment"),
			0x39 => array(0, 0, 3, 0x39, "CODECOPY", "Copy code running in current environment to memory"),
			0x3a => array(0, 0, 2, 0x3a, "GASPRICE", "Get price of gas in current environment"),
			0x3b => array(0, 0, 20, 0x3b, "EXTCODESIZE", "Get size of an account’s code"),
			0x3c => array(0, 0, 20, 0x3c, "EXTCODECOPY", "Copy an account’s code to memory"),
			...
			0x65 => array(6, 0, 3, 0x65, "PUSH6", "Place 6 byte item on stack"),
			0x66 => array(7, 0, 3, 0x66, "PUSH7", "Place 7 byte item on stack"),
			0x67 => array(8, 0, 3, 0x67, "PUSH8", "Place 8 byte item on stack"),
			0x68 => array(9, 0, 3, 0x68, "PUSH9", "Place 9 byte item on stack"),
			0x69 => array(10, 0, 3, 0x69, "PUSH10", "Place 10 byte item on stack"),
			0x6a => array(11, 0, 3, 0x6a, "PUSH11", "Place 11 byte item on stack"),
			0x6b => array(12, 0, 3, 0x6b, "PUSH12", "Place 12 byte item on stack"),
			0x6c => array(13, 0, 3, 0x6c, "PUSH13", "Place 13 byte item on stack"),
			0x6d => array(14, 0, 3, 0x6d, "PUSH14", "Place 14 byte item on stack"),
			0x6e => array(15, 0, 3, 0x6e, "PUSH15", "Place 15 byte item on stack"),
			0x6f => array(16, 0, 3, 0x6f, "PUSH16", "Place 16 byte item on stack"),
			0x70 => array(17, 0, 3, 0x70, "PUSH17", "Place 17 byte item on stack"),
			0x71 => array(18, 0, 3, 0x71, "PUSH18", "Place 18 byte item on stack"),
			0x72 => array(19, 0, 3, 0x72, "PUSH19", "Place 19 byte item on stack"),
			0x73 => array(20, 0, 3, 0x73, "PUSH20", "Place 20 byte item on stack"),
			0x74 => array(21, 0, 3, 0x74, "PUSH21", "Place 21 byte item on stack"),
			0x75 => array(22, 0, 3, 0x75, "PUSH22", "Place 22 byte item on stack"),
			0x76 => array(23, 0, 3, 0x76, "PUSH23", "Place 23 byte item on stack"),
			0x77 => array(24, 0, 3, 0x77, "PUSH24", "Place 24 byte item on stack"),
			0x78 => array(25, 0, 3, 0x78, "PUSH25", "Place 25 byte item on stack"),
			0x79 => array(26, 0, 3, 0x79, "PUSH26", "Place 26 byte item on stack"),
			0x7a => array(27, 0, 3, 0x7a, "PUSH27", "Place 27 byte item on stack"),
			0x7b => array(28, 0, 3, 0x7b, "PUSH28", "Place 28 byte item on stack"),
			0x7c => array(29, 0, 3, 0x7c, "PUSH29", "Place 29 byte item on stack"),
			0x7d => array(30, 0, 3, 0x7d, "PUSH30", "Place 30 byte item on stack"),
			0x7e => array(31, 0, 3, 0x7e, "PUSH31", "Place 31 byte item on stack"),
			0x7f => array(32, 0, 3, 0x7f, "PUSH32", "Place 32 byte (full word) item on stack"),
			0x80 => array(0, 0, 3, 0x80, "DUP1", "Duplicate 1st stack item"),
			0x81 => array(0, 0, 3, 0x81, "DUP2", "Duplicate 2nd stack item"),
			0x82 => array(0, 0, 3, 0x82, "DUP3", "Duplicate 3rd stack item"),
			0x83 => array(0, 0, 3, 0x83, "DUP4", "Duplicate 4th stack item"),
			0x84 => array(0, 0, 3, 0x84, "DUP5", "Duplicate 5th stack item"),
			0x85 => array(0, 0, 3, 0x85, "DUP6", "Duplicate 6th stack item"),
			0x86 => array(0, 0, 3, 0x86, "DUP7", "Duplicate 7th stack item"),
			0x87 => array(0, 0, 3, 0x87, "DUP8", "Duplicate 8th stack item"),
			0x88 => array(0, 0, 3, 0x88, "DUP9", "Duplicate 9th stack item"),
			0x89 => array(0, 0, 3, 0x89, "DUP10", "Duplicate 10th stack item"),
			0x8a => array(0, 0, 3, 0x8a, "DUP11", "Duplicate 11th stack item"),
			0x8b => array(0, 0, 3, 0x8b, "DUP12", "Duplicate 12th stack item"),
			0x8c => array(0, 0, 3, 0x8c, "DUP13", "Duplicate 13th stack item"),
			0x8d => array(0, 0, 3, 0x8d, "DUP14", "Duplicate 14th stack item"),
			0x8e => array(0, 0, 3, 0x8e, "DUP15", "Duplicate 15th stack item"),
			0x8f => array(0, 0, 3, 0x8f, "DUP16", "Duplicate 16th stack item"),
			0x90 => array(0, 0, 3, 0x90, "SWAP1", "Exchange 1st and 2nd stack items"),
			0x91 => array(0, 0, 3, 0x91, "SWAP2", "Exchange 1st and 3rd stack items"),
			0x92 => array(0, 0, 3, 0x92, "SWAP3", "Exchange 1st and 4th stack items"),
			0x93 => array(0, 0, 3, 0x93, "SWAP4", "Exchange 1st and 5th stack items"),
			0x94 => array(0, 0, 3, 0x94, "SWAP5", "Exchange 1st and 6th stack items"),
			0x95 => array(0, 0, 3, 0x95, "SWAP6", "Exchange 1st and 7th stack items"),
			0x96 => array(0, 0, 3, 0x96, "SWAP7", "Exchange 1st and 8th stack items"),
			0x97 => array(0, 0, 3, 0x97, "SWAP8", "Exchange 1st and 9th stack items"),
			0x98 => array(0, 0, 3, 0x98, "SWAP9", "Exchange 1st and 10th stack items"),
			0x99 => array(0, 0, 3, 0x99, "SWAP10", "Exchange 1st and 11th stack items"),
			0x9a => array(0, 0, 3, 0x9a, "SWAP11", "Exchange 1st and 12th stack items"),
			0x9b => array(0, 0, 3, 0x9b, "SWAP12", "Exchange 1st and 13th stack items"),
			0x9c => array(0, 0, 3, 0x9c, "SWAP13", "Exchange 1st and 14th stack items"),
			0x9d => array(0, 0, 3, 0x9d, "SWAP14", "Exchange 1st and 15th stack items"),
			0x9e => array(0, 0, 3, 0x9e, "SWAP15", "Exchange 1st and 16th stack items"),
			0x9f => array(0, 0, 3, 0x9f, "SWAP16", "Exchange 1st and 17th stack items"),
