...
class Opcodes
{
	...
	public function set_opcodes () {
		$this->aaOpcodes = array(
			...
			0x60 => array(0, 3, 0x60, "PUSH1", "Place 1 byte item on stack"),
			0x61 => array(0, 3, 0x61, "PUSH2", "Place 2 byte item on stack"),
			0x62 => array(0, 3, 0x62, "PUSH3", "Place 3 byte item on stack"),
			0x63 => array(0, 3, 0x63, "PUSH4", "Place 4 byte item on stack"),
			0x64 => array(0, 3, 0x64, "PUSH5", "Place 5 byte item on stack"),
			0x65 => array(0, 3, 0x65, "PUSH6", "Place 6 byte item on stack"),
			0x66 => array(0, 3, 0x66, "PUSH7", "Place 7 byte item on stack"),
			0x67 => array(0, 3, 0x67, "PUSH8", "Place 8 byte item on stack"),
			0x68 => array(0, 3, 0x68, "PUSH9", "Place 9 byte item on stack"),
			0x69 => array(0, 3, 0x69, "PUSH10", "Place 10 byte item on stack"),
			0x6a => array(0, 3, 0x6a, "PUSH11", "Place 11 byte item on stack"),
			0x6b => array(0, 3, 0x6b, "PUSH12", "Place 12 byte item on stack"),
			0x6c => array(0, 3, 0x6c, "PUSH13", "Place 13 byte item on stack"),
			0x6d => array(0, 3, 0x6d, "PUSH14", "Place 14 byte item on stack"),
			0x6e => array(0, 3, 0x6e, "PUSH15", "Place 15 byte item on stack"),
			0x6f => array(0, 3, 0x6f, "PUSH16", "Place 16 byte item on stack"),
			0x70 => array(0, 3, 0x70, "PUSH17", "Place 17 byte item on stack"),
			0x71 => array(0, 3, 0x71, "PUSH18", "Place 18 byte item on stack"),
			0x72 => array(0, 3, 0x72, "PUSH19", "Place 19 byte item on stack"),
			0x73 => array(0, 3, 0x73, "PUSH20", "Place 20 byte item on stack"),
			0x74 => array(0, 3, 0x74, "PUSH21", "Place 21 byte item on stack"),
			0x75 => array(0, 3, 0x75, "PUSH22", "Place 22 byte item on stack"),
			0x76 => array(0, 3, 0x76, "PUSH23", "Place 23 byte item on stack"),
			0x77 => array(0, 3, 0x77, "PUSH24", "Place 24 byte item on stack"),
			0x78 => array(0, 3, 0x78, "PUSH25", "Place 25 byte item on stack"),
			0x79 => array(0, 3, 0x79, "PUSH26", "Place 26 byte item on stack"),
			0x7a => array(0, 3, 0x7a, "PUSH27", "Place 27 byte item on stack"),
			0x7b => array(0, 3, 0x7b, "PUSH28", "Place 28 byte item on stack"),
			0x7c => array(0, 3, 0x7c, "PUSH29", "Place 29 byte item on stack"),
			0x7d => array(0, 3, 0x7d, "PUSH30", "Place 30 byte item on stack"),
			0x7e => array(0, 3, 0x7e, "PUSH31", "Place 31 byte item on stack"),
			0x7f => array(0, 3, 0x7f, "PUSH32", "Place 32 byte (full word) item on stack"),
...
*/
	...
	public function opcodes ($iKey = null, $sHex = null) {
		switch ($iKey) {
			case 1: return $this->aaOpcodes[$sHex][0];
			case 2: return $this->aaOpcodes[$sHex][1];
			case 3: return $this->aaOpcodes[$sHex][2];
			case 4: return $this->aaOpcodes[$sHex][3];
			case 5: return $this->aaOpcodes[$sHex][4];
